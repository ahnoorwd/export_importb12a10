...
const Latestproductcards = ({singlelatestproduct}) => {
    return (
      ...
      <div className="mt-4 space-y-1">
        ...
        <p className="text-lg font-bold text-green-600">Price :${singlelatestproduct.price}</p>

        <p className="text-sm text-gray-500">
          Origin Country: <span className="font-medium">{singlelatestproduct.originCountry}</span>
        </p>
        ...
        <p className="text-sm text-gray-500">
          Available Quantity: 
          <span className="font-medium ml-1">{singlelatestproduct.availableQuantity}</span>
        </p>
      </div>
